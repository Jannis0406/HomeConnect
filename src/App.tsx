  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <button onClick={() => navigateToPage('home')} className="flex items-center space-x-3 group">
              ...
              <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-300 bg-clip-text text-transparent">
      ...
      {currentPage === 'home' && (
        <>
          <section className="relative py-16 sm:py-24 lg:py-32 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-950 via-gray-900 to-orange-950 opacity-60"></div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <a href="#kontakt" className="border-2 border-gray-600 text-gray-200 px-8 py-4 rounded-xl hover:border-blue-600 hover:text-blue-400 hover:bg-blue-950/50 transition-all text-center font-semibold">
                      Kontakt aufnehmen
                    </a>
                  </div>
                </div>
                <div className="relative lg:block hidden">
                  ...
                  <div className="relative bg-gray-900 rounded-3xl p-8 shadow-2xl">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-gradient-to-br from-orange-950 to-orange-900 p-6 rounded-2xl">
                        <Thermometer className="h-12 w-12 text-orange-600 mb-3" />
                        <p className="text-sm font-semibold text-white">Smarte Thermostate</p>
                      </div>
                      <div className="bg-gradient-to-br from-blue-950 to-blue-900 p-6 rounded-2xl">
                        <Wifi className="h-12 w-12 text-blue-600 mb-3" />
                        <p className="text-sm font-semibold text-white">WLAN Optimierung</p>
                      </div>
                      <div className="bg-gradient-to-br from-green-950 to-green-900 p-6 rounded-2xl">
                        <Headphones className="h-12 w-12 text-green-600 mb-3" />
                        <p className="text-sm font-semibold text-white">IT-Support</p>
                      </div>
                      <div className="bg-gradient-to-br from-gray-800 to-gray-700 p-6 rounded-2xl flex items-center justify-center">
          ...
          <section id="leistungen" className="py-16 sm:py-24 bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Unsere Leistungen</h2>
                <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">Professionelle Smart Home Lösungen für jeden Bedarf</p>
              </div>

              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <div
                  className="group bg-gradient-to-br from-orange-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-orange-800 hover:border-orange-300 hover:shadow-2xl transition-all cursor-pointer transform hover:-translate-y-2"
                  onClick={() => navigateToPage('thermostats')}
                >
                ...
                <div
                  className="group bg-gradient-to-br from-blue-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-blue-800 hover:border-blue-300 hover:shadow-2xl transition-all cursor-pointer transform hover:-translate-y-2"
                  onClick={() => navigateToPage('wlan')}
                >
                  <div className="bg-gradient-to-br from-blue-9500 to-blue-600 w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <div
                  className="group bg-gradient-to-br from-green-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-green-800 hover:border-green-300 hover:shadow-2xl transition-all cursor-pointer transform hover:-translate-y-2"
                  onClick={() => navigateToPage('support')}
                >
                  <div className="bg-gradient-to-br from-green-9500 to-green-600 w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <section id="vorteile" className="py-16 sm:py-24 bg-gray-900 from-gray-800 to-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Warum HomeConnectSolutions?</h2>
                <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">Ihre Vorteile mit uns als Partner</p>
              </div>

              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                <div className="text-center bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-300">Optimale Lösungen für Ihr Zuhause</p>
                </div>
                ...
                <div className="text-center bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-300">Stabile und sichere Technologie</p>
                </div>
                ...
                <div className="text-center bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-300">Nachhaltige Energieeinsparung</p>
                </div>
                ...
                <div className="text-center bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-300">Professionelle Beratung & Support</p>
                </div>
              </div>
            </div>
          </section>

          <section id="kontakt" className="py-16 sm:py-24 bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">Kontaktieren Sie uns</h2>
                <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto">Wir freuen uns auf Ihre Nachricht</p>
              </div>

              <div className="grid lg:grid-cols-2 gap-12">
                <div>
                  <div className="space-y-6">
                    <div className="flex items-start bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border border-blue-800">
                      <div className="bg-blue-600 p-3 rounded-xl">
                        <Phone className="h-6 w-6 text-white" />
                      </div>
                      <div className="ml-4">
                        <h3 className="font-bold text-white mb-1">Telefon</h3>
                        <p className="text-gray-300">+49 (0) 30 1234 5678</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border border-blue-800">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-300">info@homeconnect.de</p>
                      </div>
                    </div>
                ...
                <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-blue-800">
                  <form className="space-y-6">
                    <div>
                      <label className="block text-sm font-semibold text-gray-200 mb-2">Name</label>
                      <input
                        type="text"
                        className="w-full px-4 py-3 border-2 border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                        placeholder="Ihr Name"
                      />
                    </div>

                    <div>
                      <label className="block text-sm font-semibold text-gray-200 mb-2">E-Mail</label>
                      <input
                        type="email"
                        className="w-full px-4 py-3 border-2 border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-200 mb-2">Nachricht</label>
                      <textarea
                        rows={4}
                        className="w-full px-4 py-3 border-2 border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
      ...
      {currentPage === 'thermostats' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 pb-16">
          <section className="relative bg-gradient-to-br from-orange-950 via-white to-orange-900 py-16 sm:py-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
              <div className="text-center mb-12">
                <div className="inline-flex items-center justify-center bg-gradient-to-br from-orange-9500 to-orange-600 p-6 rounded-3xl mb-6 shadow-2xl">
                ...
                <div className="inline-flex bg-white/80 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-gray-700">
                  <a href="#warum" className="px-6 py-3 rounded-xl text-gray-200 hover:bg-orange-100 hover:text-orange-700 transition-all font-medium">
                    Vorteile
                  </a>
                  <a href="#pakete" className="px-6 py-3 rounded-xl text-gray-200 hover:bg-orange-100 hover:text-orange-700 transition-all font-medium">
                    Pakete
                  </a>
                  <button onClick={() => navigateToPage('hardware')} className="px-6 py-3 rounded-xl bg-gradient-to-r from-orange-9500 to-orange-600 text-white hover:shadow-lg transition-all font-medium">
                    Vergleich
                  </button>
                </div>
              </div>
          ...
          <section id="warum" className="py-12 sm:py-16 bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="mb-16">
                <div className="text-center mb-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="group bg-gray-900 p-8 rounded-3xl border-2 border-orange-800 hover:border-orange-300 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                    ...
                    <p className="text-gray-300 leading-relaxed">Reduzieren Sie Ihre Heizkosten durch intelligente Steuerung und Automatisierung erheblich.</p>
                  </div>
                  <div className="group bg-gray-900 p-8 rounded-3xl border-2 border-blue-800 hover:border-blue-300 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                    ...
                    <p className="text-gray-300 leading-relaxed">Steuern Sie Ihre Heizung von überall per App und genießen Sie immer die perfekte Temperatur.</p>
                  </div>
                  <div className="group bg-gray-900 p-8 rounded-3xl border-2 border-green-800 hover:border-green-300 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                    ...
                    <p className="text-gray-300 leading-relaxed">Senken Sie Ihren CO₂-Ausstoß durch optimiertes Heizen und schonen Sie die Umwelt.</p>
                  </div>
                </div>
              </div>
              ...
              <div id="pakete" className="mb-16">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-gray-300 max-w-2xl mx-auto">Wählen Sie die perfekte Lösung für Ihr Zuhause</p>
                </div>
                <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                  <div className="group bg-gray-900 border-2 border-blue-700 rounded-3xl p-8 hover:shadow-2xl hover:border-blue-400 transition-all transform hover:-translate-y-1">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-300 mb-4">TP-Link Hardware für normale Heizkörper</p>
                      ...
                      <p className="text-sm text-gray-400">nach individueller Beratung</p>
                    </div>

                    <ul className="space-y-3 mb-8">
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">TP-Link smarte Thermostate</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Nur für normale Heizkörper (keine Fußbodenheizung)</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">App-Steuerung & Automatisierung</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Zeitpläne & Szenarien</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Fenster-Auf-Erkennung (gegen Aufpreis mit extra Sensor)</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Professionelle Installation</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Herstellergarantie</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200">Support & Beratung</span>
                      </li>
                    </ul>
                  ...
                  <div className="group bg-gradient-to-br from-orange-950 to-gray-900 border-4 border-orange-400 rounded-3xl p-8 hover:shadow-2xl hover:border-orange-500 transition-all relative transform hover:-translate-y-1">
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-orange-9500 to-orange-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-xl">
                      ⭐ EMPFOHLEN
                    </div>
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-300 mb-4">tado° Hardware inkl. Fußbodenheizung</p>
                      <div className="inline-block bg-gradient-to-r from-orange-9500 to-orange-600 text-white px-6 py-2 rounded-full text-lg font-bold mb-2 shadow-lg">Preis auf Anfrage</div>
                      <p className="text-sm text-gray-400">nach individueller Beratung</p>
                    </div>
                    ...
                    <ul className="space-y-3 mb-8">
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">tado° smarte Thermostate (deutscher Hersteller)</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Kompatibel mit Fußbodenheizung</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Premium App mit erweiterten Funktionen</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Intelligente Heizungssteuerung</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Fenster-Auf-Erkennung (integriert)</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Sprachsteuerung (Alexa, Google, Siri)</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Geofencing & Wetterdaten-Integration</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Professionelle Installation & Einrichtung</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Herstellergarantie</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-600 mr-3 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-200 font-medium">Premium-Support & Beratung</span>
                      </li>
                    </ul>

                    <a href="#kontakt" className="block w-full bg-gradient-to-r from-orange-9500 to-orange-600 text-white px-6 py-4 rounded-xl hover:shadow-xl transition-all font-semibold text-center group-hover:scale-105">
                      Beratung anfragen
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-8 sm:p-12 rounded-3xl shadow-2xl">
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <button onClick={() => navigateToPage('hardware')} className="bg-gray-900 text-blue-700 px-8 py-4 rounded-xl hover:shadow-xl transition-all font-bold text-lg hover:scale-105 transform">
      ...
      {currentPage === 'wlan' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 pb-16">
          <section className="bg-gradient-to-br from-blue-950 to-gray-900 py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col sm:flex-row items-center mb-6">
                <div className="bg-gradient-to-br from-blue-9500 to-blue-600 p-4 rounded-2xl mr-0 sm:mr-6 mb-4 sm:mb-0 shadow-lg">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="text-lg sm:text-xl text-gray-300 mt-2">Perfekte Verbindung in jedem Raum</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-16">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Netzwerkanalyse</h3>
                    <p className="text-gray-300">Umfassende Analyse Ihrer bestehenden WLAN-Infrastruktur und Identifikation von Schwachstellen.</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Mesh-WLAN Installation</h3>
                    <p className="text-gray-300">Installation moderner Mesh-Systeme für lückenlose Abdeckung ohne Geschwindigkeitsverlust.</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Geschwindigkeitsoptimierung</h3>
                    <p className="text-gray-300">Optimierung der Kanaleinstellungen und Reduzierung von Interferenzen für maximale Geschwindigkeit.</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Sicherheitskonfiguration</h3>
                    <p className="text-gray-300">Einrichtung von WPA3-Verschlüsselung und Gast-Netzwerken für maximale Sicherheit.</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Access Point Setup</h3>
                    <p className="text-gray-300">Strategische Platzierung von Access Points für optimale Signalverteilung.</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 rounded-2xl border-2 border-blue-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Wartung & Support</h3>
                    <p className="text-gray-300">Regelmäßige Updates und Support bei WLAN-Problemen.</p>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-blue-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-blue-700 shadow-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <button onClick={() => navigateToPage('home')} className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-xl hover:bg-blue-950/50 transition-all font-semibold">
      ...
      {currentPage === 'support' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 pb-16">
          <section className="bg-gradient-to-br from-green-950 to-gray-900 py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col sm:flex-row items-center mb-6">
                <div className="bg-gradient-to-br from-green-9500 to-green-600 p-4 rounded-2xl mr-0 sm:mr-6 mb-4 sm:mb-0 shadow-lg">
                  <Headphones className="h-12 w-12 text-white" />
                </div>
                <div className="text-center sm:text-left">
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white">IT-Support</h1>
                  <p className="text-lg sm:text-xl text-gray-300 mt-2">Professionelle Hilfe für Ihr Smart Home</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-16">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Kompetente Beratung</h3>
                    <p className="text-gray-300 mb-4">Professionelle Unterstützung bei allen Fragen rund um Ihr Smart Home.</p>
                  ...
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    ...
                    <p className="text-gray-300">Fernwartung für schnelle Problembehebung ohne Vor-Ort-Termin.</p>
                  </div>
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Vor-Ort Service</h3>
                    <p className="text-gray-300">Persönlicher Service bei Ihnen zu Hause für komplexe Installationen und Reparaturen.</p>
                  </div>
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Schulungen</h3>
                    <p className="text-gray-300">Einführungen und Schulungen für die optimale Nutzung Ihrer Smart Home Geräte.</p>
                  </div>
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Wartungsverträge</h3>
                    <p className="text-gray-300">Regelmäßige Wartung und Updates für langfristige Systemstabilität.</p>
                  </div>
                  <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 rounded-2xl border-2 border-green-800 shadow-lg">
                    <h3 className="font-bold text-white mb-3 text-lg">Systemdiagnose</h3>
                    <p className="text-gray-300">Umfassende Analyse und Optimierung Ihrer Smart Home Infrastruktur.</p>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-green-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-green-700 shadow-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="tel:+4903012345678" className="border-2 border-green-600 text-green-600 px-8 py-3 rounded-xl hover:bg-green-950/50 transition-all text-center font-semibold">
                    +49 (0) 30 1234 5678
                  </a>
                </div>
              </div>
      ...
      {currentPage === 'impressum' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="prose max-w-none bg-gray-900 p-6 sm:p-8 rounded-3xl shadow-lg">
      ...
      {currentPage === 'hardware' && (
        <div className="min-h-screen bg-gradient-to-br from-gray-800 to-gray-900 pb-16">
          <section className="bg-gradient-to-br from-orange-950 to-gray-900 py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex justify-center gap-3 mt-8 flex-wrap">
                <a href="#pakete-detail" className="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl text-gray-200 hover:bg-gray-900 hover:shadow-md transition-all font-medium border border-gray-700">
                  Pakete im Detail
                </a>
                <a href="#vergleichstabelle" className="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl text-gray-200 hover:bg-gray-900 hover:shadow-md transition-all font-medium border border-gray-700">
                  Vergleichstabelle
                </a>
                <a href="#empfehlung" className="bg-white/80 backdrop-blur-sm px-4 py-2 rounded-xl text-gray-200 hover:bg-gray-900 hover:shadow-md transition-all font-medium border border-gray-700">
                  Empfehlungen
                </a>
              </div>
            </div>
          ...
          <section id="pakete-detail" className="py-12 sm:py-16 bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid lg:grid-cols-2 gap-8 mb-16">
                <div className="bg-gray-900 border-2 border-gray-700 rounded-3xl p-6 sm:p-8 hover:shadow-2xl transition-all">
                  <div className="bg-gradient-to-br from-blue-9500 to-blue-600 text-white px-6 py-3 rounded-2xl text-center mb-6">
                ...
                <div className="bg-gradient-to-br from-orange-950 to-gray-900 border-2 border-orange-500 rounded-3xl p-6 sm:p-8 hover:shadow-2xl transition-all relative">
                  ...
                  <div className="bg-gradient-to-br from-orange-9500 to-orange-600 text-white px-6 py-3 rounded-2xl text-center mb-6 mt-8">
              ...
              <div id="empfehlung" className="mt-12 bg-gradient-to-br from-blue-950 to-gray-900 p-6 sm:p-8 rounded-3xl border-2 border-blue-700 shadow-xl">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 text-center">Welches Paket ist das richtige für Sie?</h3>
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-gray-900 p-6 rounded-2xl border-2 border-gray-700">
                  ...
                  <div className="bg-gradient-to-br from-orange-950 to-gray-900 p-6 rounded-2xl border-2 border-orange-300">
                    <h4 className="font-bold text-white mb-3 flex items-center">
                      <div className="bg-orange-100 p-2 rounded-lg mr-3">
